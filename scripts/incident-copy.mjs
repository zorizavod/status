...
const SERVICE_PHRASES = {
  mrp: {
    down: "рабочее место МРП не открывается",
    degraded: "рабочее место МРП открывается дольше обычного",
    again: "рабочее место МРП снова открывается",
  },
  api: {
    down: "рабочее место МРП открывается, но не показывает и не сохраняет данные",
    degraded:
      "рабочее место МРП открывается, но списки и сохранение ждут дольше обычного",
    again: "рабочее место МРП снова показывает и сохраняет данные",
  },
  database: {
    down: "рабочее место МРП не сохраняет и не показывает данные",
    degraded: "сохранение и списки в рабочем месте МРП отвечают дольше обычного",
    again: "рабочее место МРП снова сохраняет и показывает данные",
  },
  website: {
